...
#define DEVICEID   "23368337"//改成自己的
#define PROJECTID "113899"//改成自己的
#define HOST_PORT   (80)
String apiKey="hOLSXll3NjDSg6SJFIhjIxfYsfg=";//改成自己的
char buf[10];
...
float  sensor_lux;                    //传感器光照   
char   sensor_hum_c[7], sensor_lux_c[7],sensor_warning_c[7] ;    //换成char数组传输
